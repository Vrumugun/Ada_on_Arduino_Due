# Ada UART Example for Arduino Due
...
- alr exec -- arm-eabi-objcopy -O binary .\bin\uart_example .\bin\uart_example.bin
- Press ERASE on the board.
- Press RESET on the board.
- ..\bossac\1.6.1-arduino\bossac -p COM3 -U false -e -w -v -b bin\uart_example.bin -R
