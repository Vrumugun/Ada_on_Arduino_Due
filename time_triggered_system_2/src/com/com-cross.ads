...
package COM.Cross is
   ...
   procedure Update_Tx;
   procedure Update_Rx;
   procedure Configure_USART_Pins;
   ...
   function Get_Rx_Counter return Natural;
   function Get_Tx_Counter return Natural;

   package On_Update_Tx is
     new A0B.Callbacks.Generic_Parameterless (Update_Tx);
   package On_Update_Rx is
     new A0B.Callbacks.Generic_Parameterless (Update_Rx);
