...
package body HAL.SysTick_Clock_Timer is
   ...
   procedure Set_Tick_Callback (Callback : A0B.Callbacks.Callback) is
   begin
      HAL.SysTick_Clock_Timer.Callback := Callback;
   end Set_Tick_Callback;
   ...
   begin
      ...
      A0B.Callbacks.Emit (HAL.SysTick_Clock_Timer.Callback);
   end SysTick_Handler;
